...
function R1_1(){
    ...
    document.cookie = 'ReqSQL1=Application mobile';
...
function R1_2(){
    ...
    document.cookie = 'ReqSQL1=Base de donnees';
...
function R1_3(){
    ...
    document.cookie = 'ReqSQL1=Embarque';
...
function R1_4(){
    ...
    document.cookie = 'ReqSQL1=General';
...
function R1_6(){
    ...
    document.cookie = 'ReqSQL1=Intervention sur les donnees';
...
function R1_7(){
    ...
    document.cookie = 'ReqSQL1=Livraison et Mise à jour';
...
function R1_8(){
    ...
    document.cookie = 'ReqSQL1=Server';
...
function R1_9(){
    ...
    document.cookie = 'ReqSQL1=Siri et Siri Light';
...
function R1_10(){
    ...
    document.cookie = 'ReqSQL1=Non determine';
...
function R2_1(){
    ...
    document.cookie = 'ReqSQL2=Mineur';
    Action2();
...
function R2_2(){
    ...
    document.cookie = 'ReqSQL2=Majeur';
    Action2();
...
function R2_3(){
    ...
    document.cookie = 'ReqSQL2=Bloquant';
    Action2();
...
function R2_4(){
    ...
    document.cookie = 'ReqSQL2=Simple';
    Action2();
...
function R2_5(){
    ...
    document.cookie = 'ReqSQL2=Critique';
    Action2();
...
function R2_6(){
    ...
    document.cookie = 'ReqSQL2=Fonctionnalité';
    Action2();
...
function R2_7(){
    ...
    document.cookie = 'ReqSQL2=Cosmétique';
    Action2();
...
function R2_8(){
    ...
    document.cookie = 'ReqSQL2=Server';
    Action2();
